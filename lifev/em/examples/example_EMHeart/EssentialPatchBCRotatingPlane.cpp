            ...
            for (int j (0); j < nCompLocalDof; ++j)
            {
                     ...
                     //   QP[2] = coordinates[2] - current_point_on_plane[2];
                        ...
                        if(QP.dot(direction) <= 0) //here i have change to > 0
                        {
                            ...
                            std::ostringstream timee;//this is to convert int to string
                            oss << time;
                            //double time1 = time;
                            
                            std::string path = "/cluster/home/lglaus/LIFE5/lifev-env-rp/lifev-em-install/lifev/em/examples/example_EMHeart/distancefiles/distances_" +std::to_string(m_Name)+time.str()+ oss.str() + ".dat"; //2020.02.05 lg
